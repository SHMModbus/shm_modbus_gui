...
class Ui_InspectSHM(object):
    def setupUi(self, InspectSHM):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 784, 409))
        self.gridLayout_3 = QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.data_table = QTableWidget(self.scrollAreaWidgetContents)
        if (self.data_table.columnCount() < 8):
    ...
    def retranslateUi(self, InspectSHM):
        ...
        self.button_add_char_array.setText(QCoreApplication.translate("InspectSHM", u"add char array", None))
