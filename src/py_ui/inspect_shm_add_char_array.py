...
################################################################################
## Form generated from reading UI file 'inspect_shm_add_char_array.ui'
##
...
class Ui_InspectSHMAddCharArray(object):
    def setupUi(self, InspectSHMAddCharArray):
        if not InspectSHMAddCharArray.objectName():
            InspectSHMAddCharArray.setObjectName(u"InspectSHMAddCharArray")
        InspectSHMAddCharArray.resize(320, 340)
        InspectSHMAddCharArray.setMinimumSize(QSize(320, 150))
        InspectSHMAddCharArray.setMaximumSize(QSize(16777215, 16777215))
        self.gridLayout = QGridLayout(InspectSHMAddCharArray)
        self.gridLayout.setObjectName(u"gridLayout")
        self.button_add = QPushButton(InspectSHMAddCharArray)
        self.button_add.setObjectName(u"button_add")

        self.gridLayout.addWidget(self.button_add, 3, 0, 1, 2)

        self.line = QFrame(InspectSHMAddCharArray)
        ...
        self.scrollArea = QScrollArea(InspectSHMAddCharArray)
        ...
        self.retranslateUi(InspectSHMAddCharArray)

        QMetaObject.connectSlotsByName(InspectSHMAddCharArray)
    # setupUi

    def retranslateUi(self, InspectSHMAddCharArray):
        InspectSHMAddCharArray.setWindowTitle(QCoreApplication.translate("InspectSHMAddCharArray", u"Add Char Array", None))
        self.button_add.setText(QCoreApplication.translate("InspectSHMAddCharArray", u"Add", None))
        self.address.setPrefix(QCoreApplication.translate("InspectSHMAddCharArray", u"0x", None))
        self.name.setText(QCoreApplication.translate("InspectSHMAddCharArray", u"String", None))
        self.label_3.setText(QCoreApplication.translate("InspectSHMAddCharArray", u"Register:", None))
        self.reg_AO.setText(QCoreApplication.translate("InspectSHMAddCharArray", u"AO", None))
        self.reg_AI.setText(QCoreApplication.translate("InspectSHMAddCharArray", u"AI", None))
        self.label_2.setText(QCoreApplication.translate("InspectSHMAddCharArray", u"Address (hex):", None))
        self.label_4.setText(QCoreApplication.translate("InspectSHMAddCharArray", u"Name:", None))
        self.label_6.setText(QCoreApplication.translate("InspectSHMAddCharArray", u"Address (dec):", None))
        self.label.setText(QCoreApplication.translate("InspectSHMAddCharArray", u"Length:", None))
    # retranslateUi
