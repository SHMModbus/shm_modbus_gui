...
################################################################################
## Form generated from reading UI file 'set_values_add_int.ui'
##
...
class Ui_InspectSHMAddInt(object):
    def setupUi(self, InspectSHMAddInt):
        ...
        InspectSHMAddInt.resize(320, 627)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 304, 571))
        ...
        self.endian_reversed.setEnabled(False)
        ...
        self.size_1_lo = QRadioButton(self.widget)
        self.size_1_lo.setObjectName(u"size_1_lo")

        self.verticalLayout.addWidget(self.size_1_lo)

        self.size_1_hi = QRadioButton(self.widget)
        self.size_1_hi.setObjectName(u"size_1_hi")

        self.verticalLayout.addWidget(self.size_1_hi)
    ...
    def retranslateUi(self, InspectSHMAddInt):
        ...
        self.label_4.setText(QCoreApplication.translate("InspectSHMAddInt", u"Type:", None))
        ...
        self.size_1_lo.setText(QCoreApplication.translate("InspectSHMAddInt", u"1 Byte (low)", None))
        self.size_1_hi.setText(QCoreApplication.translate("InspectSHMAddInt", u"1 Byte (high)", None))
        ...
        self.type_unsigned.setText(QCoreApplication.translate("InspectSHMAddInt", u"unsigned", None))
        self.type_signed.setText(QCoreApplication.translate("InspectSHMAddInt", u"signed", None))
