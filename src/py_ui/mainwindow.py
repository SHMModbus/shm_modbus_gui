...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 745, 595))
        ...
        self.tool_hexdump_do = QPushButton(self.scrollAreaWidgetContents)
        self.tool_hexdump_do.setObjectName(u"tool_hexdump_do")
        self.tool_hexdump_do.setEnabled(True)

        self.verticalLayout_3.addWidget(self.tool_hexdump_do)

        self.tool_hexdump_di = QPushButton(self.scrollAreaWidgetContents)
        self.tool_hexdump_di.setObjectName(u"tool_hexdump_di")
        self.tool_hexdump_di.setEnabled(True)

        self.verticalLayout_3.addWidget(self.tool_hexdump_di)

        self.tool_hexdump_ao = QPushButton(self.scrollAreaWidgetContents)
        self.tool_hexdump_ao.setObjectName(u"tool_hexdump_ao")
        self.tool_hexdump_ao.setEnabled(True)

        self.verticalLayout_3.addWidget(self.tool_hexdump_ao)

        self.tool_hexdump_ai = QPushButton(self.scrollAreaWidgetContents)
        self.tool_hexdump_ai.setObjectName(u"tool_hexdump_ai")
        self.tool_hexdump_ai.setEnabled(True)

        self.verticalLayout_3.addWidget(self.tool_hexdump_ai)
        ...
        self.tool_random_do = QPushButton(self.scrollAreaWidgetContents)
        self.tool_random_do.setObjectName(u"tool_random_do")

        self.verticalLayout_5.addWidget(self.tool_random_do)

        self.tool_random_di = QPushButton(self.scrollAreaWidgetContents)
        self.tool_random_di.setObjectName(u"tool_random_di")

        self.verticalLayout_5.addWidget(self.tool_random_di)

        self.tool_random_ao = QPushButton(self.scrollAreaWidgetContents)
        self.tool_random_ao.setObjectName(u"tool_random_ao")

        self.verticalLayout_5.addWidget(self.tool_random_ao)

        self.tool_random_ai = QPushButton(self.scrollAreaWidgetContents)
        self.tool_random_ai.setObjectName(u"tool_random_ai")

        self.verticalLayout_5.addWidget(self.tool_random_ai)
        ...
        self.tool_inspec_values = QPushButton(self.scrollAreaWidgetContents)
        self.tool_inspec_values.setObjectName(u"tool_inspec_values")

        self.verticalLayout_6.addWidget(self.tool_inspec_values)

        self.tool_set_values = QPushButton(self.scrollAreaWidgetContents)
        self.tool_set_values.setObjectName(u"tool_set_values")
        self.tool_set_values.setEnabled(True)

        self.verticalLayout_6.addWidget(self.tool_set_values)
        ...
        self.gridLayout_26.addLayout(self.horizontalLayout_6, 6, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.widget_22, 4, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.line_12, 3, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.line_8, 1, 0, 1, 1)
        ...
        self.clien_id_selector = QComboBox(self.scrollAreaWidgetContents)
        self.clien_id_selector.setObjectName(u"clien_id_selector")
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy4.setHorizontalStretch(1)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.clien_id_selector.sizePolicy().hasHeightForWidth())
        self.clien_id_selector.setSizePolicy(sizePolicy4)

        self.horizontalLayout_2.addWidget(self.clien_id_selector)


        self.gridLayout_26.addLayout(self.horizontalLayout_2, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"client id:", None))
